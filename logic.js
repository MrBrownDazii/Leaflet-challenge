// Perform API call using USGS API to pull in earthquake data into jason.
...
function createFeatures(earthquakeData) {
  ...
  var earthquakes = L.geoJSON(earthquakeData,{
    ...
    onEachFeature: function(feature, layer){
      layer.bindPopup("<h1 > Magnitude: "+ feature.properties.mag + 
      "</h1><h3>Location: " + feature.properties.place +
...
function createMap(earthquakes) {
  ...
  // Define lightmap, outdoorsmap, and satellite layers
  let mapboxUrl = 'https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}';
  let accessToken = 'pk.eyJ1IjoicGFham9lIiwiYSI6ImNrMThnZmg3bDFxeDYza28zeHFsbWRqZXAifQ.wu7QrjgLr6zTSPiM-49F7w';
  ...
  let satellite = L.tileLayer(mapboxUrl, {id: 'mapbox.streets-satellite', maxZoom: 20, accessToken: accessToken});
